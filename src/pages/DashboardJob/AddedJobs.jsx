                            ...
                            <div className="vstack gap-4">
                                <div className="d-flex">
                                    ...
                                    <div className="ms-2 flex-grow-1">
                                        ...
                                        <p className="text-muted mb-0">apcodes, USA - <b>53</b> sec ago</p>
                                    </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="ms-2 flex-grow-1">
                                        ...
                                        <p className="text-muted mb-0">apcodes Themes, Louisiana - <b>2</b> hrs ago</p>
                                    </div>
                                    <UncontrolledDropdown>
                                        <DropdownToggle className="btn btn-light" type="button" id="dropdownMenuButton1">
                                            <i className="bx bx-dots-vertical-rounded"></i>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="ms-2 flex-grow-1">
                                        <h6 className="mb-1 font-size-15"><a href="job-details.html" className="text-body">Marketing Director</a></h6>
                                        <p className="text-muted mb-0">apcodes Technology, Dominica - <b>1</b> days ago</p>
                                    </div>
                                    <UncontrolledDropdown>
                                        <DropdownToggle className="btn btn-light" type="button" id="dropdownMenuButton1">
                                            <i className="bx bx-dots-vertical-rounded"></i>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="ms-2 flex-grow-1">
                                        ...
                                        <p className="text-muted mb-0">apcodes, Russia - <b>2</b> days ago</p>
                                    </div>
                                    <UncontrolledDropdown>
                                        <DropdownToggle className="btn btn-light" type="button" id="dropdownMenuButton1">
                                            <i className="bx bx-dots-vertical-rounded"></i>
