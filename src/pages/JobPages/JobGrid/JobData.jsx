...
import { Card, CardBody, Col, Modal, ModalBody, ModalHeader, Row, Form, Label, Input, Pagination } from 'reactstrap';
                            ...
                            <CardBody>
                                ...
                                <ul className="list-inline mb-0">
                                    <li className="list-inline-item">
                                        <p className="text-muted fs-14 mb-1">apcodes Technology Pvt.Ltd</p>
                                    </li>{" "}
                                    <li className="list-inline-item">
