...
const CandidateList = () => {
    document.title = "Candidate List | apcodes - Vite React Admin & Dashboard Template";
                                    ...
                                    <form action="#">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={2} lg={6}>
                                                <div className="position-relative">
                                                    <div id="datepicker1">
                                                        <Input type="text" className="form-control" placeholder="Select date" data-date-format="dd M, yyyy" data-date-autoclose="true" data-date-container='#datepicker1' data-provide="datepicker" />
                                                    </div>
                                                </div>
                                            </Col>
