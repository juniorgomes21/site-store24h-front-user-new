...
const Payments = props => {
    ...
    //meta title
    document.title="store24h - Agente | Pagamentos";
    ...
    return (
        ...
        <div className="page-content">
            ...
            {/* Render Breadcrumb */}
            <Breadcrumbs
                title={props.t("Pagamentos")}
                breadcrumbItem={props.t("Pagamentos")}
            />
                <div style={{ marginBottom: '2%'}}>
                    <p>Você pode solicitar um pagamento a qualquer momento conveniente nesta página.</p>
                    <p>Os pagamentos são processados ​​em 24 horas</p>
                    <p>valor atualmente disponível para pagamentos é de R$ 13.692,68.</p>
                    <a>Congelado no aluguel - 0,00 esfregar. </a>
                </div>
                <div>
                    <Button variant="outlined" style={{ marginLeft: '0.5%' }} >Solicitar saque de Dinheiro</Button>
                    <Button variant="outlined" style={{ marginLeft: '0.5%' }} >Transferir para a conta do usuário store24h</Button>
                </div>
