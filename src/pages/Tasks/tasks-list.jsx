...
const TasksList = () => {
  ...
  //meta title
  document.title="Task List | apcodes - Vite React Admin & Dashboard Template";
                    ...
                    <table className="table table-nowrap align-middle mb-0">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <h5 className="text-truncate font-size-14 m-0"><Link to="#" className="text-dark">Create a apcodes Dashboard UI</Link></h5>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <h5 className="text-truncate font-size-14 m-0"><Link to="#" className="text-dark">Create a apcodes Logo</Link></h5>
                          </td>
                          <td>
                            <div className="avatar-group">
                              <div className="avatar-group-item">
