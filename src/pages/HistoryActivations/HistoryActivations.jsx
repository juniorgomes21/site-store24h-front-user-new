...
const HistoryActivations = props => {

    //meta title
    document.title="store24h - Agente | Histórico e Ativações";
...
HistoryActivations.propTypes = {
  t: PropTypes.any,
  chartsData: PropTypes.any,
  onGetChartsData: PropTypes.func,
};

export default withTranslation()(HistoryActivations);
